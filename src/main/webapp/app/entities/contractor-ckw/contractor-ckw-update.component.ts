...
export class ContractorCkwUpdateComponent implements OnInit {
    ...
    constructor(private contractorService: ContractorCkwService, private activatedRoute: ActivatedRoute) {}
    ...
    private subscribeToSaveResponse(result: Observable<HttpResponse<IContractorCkw>>) {
