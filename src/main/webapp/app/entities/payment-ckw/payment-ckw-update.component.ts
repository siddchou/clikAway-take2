...
export class PaymentCkwUpdateComponent implements OnInit {
    ...
    constructor(private paymentService: PaymentCkwService, private activatedRoute: ActivatedRoute) {}
    ...
    private subscribeToSaveResponse(result: Observable<HttpResponse<IPaymentCkw>>) {
