...
export class AppUserCkwUpdateComponent implements OnInit {
    ...
    constructor(private appUserService: AppUserCkwService, private activatedRoute: ActivatedRoute) {}
    ...
    private subscribeToSaveResponse(result: Observable<HttpResponse<IAppUserCkw>>) {
