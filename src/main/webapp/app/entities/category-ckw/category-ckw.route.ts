...
export class CategoryCkwResolve implements Resolve<ICategoryCkw> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).pipe(map((category: HttpResponse<CategoryCkw>) => category.body));
        }
...
export const categoryRoute: Routes = [
    {
        ...
        data: {
            ...
            defaultSort: 'id,asc',
            pageTitle: 'clikawayApp.category.home.title'
        },
        canActivate: [UserRouteAccessService]
    },
    {
        path: 'category-ckw/:id/view',
