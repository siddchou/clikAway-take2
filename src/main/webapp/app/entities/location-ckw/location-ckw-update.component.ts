...
export class LocationCkwUpdateComponent implements OnInit {
    ...
    constructor(private locationService: LocationCkwService, private activatedRoute: ActivatedRoute) {}
    ...
    private subscribeToSaveResponse(result: Observable<HttpResponse<ILocationCkw>>) {
