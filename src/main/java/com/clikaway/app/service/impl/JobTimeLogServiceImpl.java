...
import com.clikaway.app.service.JobTimeLogService;
import com.clikaway.app.domain.JobTimeLog;
import com.clikaway.app.repository.JobTimeLogRepository;
import com.clikaway.app.repository.search.JobTimeLogSearchRepository;
import com.clikaway.app.service.dto.JobTimeLogDTO;
import com.clikaway.app.service.mapper.JobTimeLogMapper;
...
public class JobTimeLogServiceImpl implements JobTimeLogService {
    ...
    private JobTimeLogSearchRepository jobTimeLogSearchRepository;
    ...
    public void delete(Long id) {
        log.debug("Request to delete JobTimeLog : {}", id);
        jobTimeLogRepository.deleteById(id);
