...
import com.clikaway.app.service.UserAddressMapService;
import com.clikaway.app.domain.UserAddressMap;
import com.clikaway.app.repository.UserAddressMapRepository;
import com.clikaway.app.repository.search.UserAddressMapSearchRepository;
import com.clikaway.app.service.dto.UserAddressMapDTO;
import com.clikaway.app.service.mapper.UserAddressMapMapper;
...
public class UserAddressMapServiceImpl implements UserAddressMapService {
    ...
    private UserAddressMapSearchRepository userAddressMapSearchRepository;
    ...
    public void delete(Long id) {
        log.debug("Request to delete UserAddressMap : {}", id);
