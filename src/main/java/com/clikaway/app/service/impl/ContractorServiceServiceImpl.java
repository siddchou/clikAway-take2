...
import com.clikaway.app.service.ContractorServiceService;
import com.clikaway.app.domain.ContractorService;
import com.clikaway.app.repository.ContractorServiceRepository;
import com.clikaway.app.repository.search.ContractorServiceSearchRepository;
import com.clikaway.app.service.dto.ContractorServiceDTO;
import com.clikaway.app.service.mapper.ContractorServiceMapper;
...
public class ContractorServiceServiceImpl implements ContractorServiceService {
    ...
    private ContractorServiceSearchRepository contractorServiceSearchRepository;
    ...
    public void delete(Long id) {
        log.debug("Request to delete ContractorService : {}", id);
        contractorServiceRepository.deleteById(id);
